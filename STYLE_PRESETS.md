...
Curated visual styles for DK Slides. Each preset includes specific font choices, color palettes, and animation approaches to ensure distinctive, non-generic designs.

**Note:** The default style for this skill is **DK Horse** (see SKILL.md). Use these presets when you want alternative looks.

---

## DK Brand Theme (Default)

### DK Horse

**Vibe:** Professional, confident, clean, sports-focused

**Typography:**
- Display: `General Sans` (600/700) — Clean, modern sans-serif
- Body: `Zodiak` (400) — Elegant serif for subtitles
...
**Signature Elements:**
- Subtle green grid pattern background
- Green glow on hover states
- Dark cards with subtle borders
- Monochromatic green accents (no secondary color)
- Clean, minimal decorative elements

**Animation Style:**
- Medium speed (0.5-0.7s)
- Slide up + fade entrances
- Staggered reveals
- Green glow pulses on active states
...
|------|--------------|-----------|--------|
| DK Brand | General Sans | Zodiak | Fontshare |
...
class ParticleSystem {
    ...
    animate() {
        ...
        this.particles.forEach(p => {
            ...
            this.ctx.fillStyle = 'rgba(141, 198, 63, 0.5)'; /* DK Green */
            this.ctx.fill();
        });
